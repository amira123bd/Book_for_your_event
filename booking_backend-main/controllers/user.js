...
exports.signup = (req, res) => {
  ...
  User.findOne({ email }).select('+hashed_password').exec((err, user) => {
    ...
    const emailData = {
      from: "bookingapp133@gmail.com", // MAKE SURE THIS EMAIL IS YOUR GMAIL FOR WHICH YOU GENERATED APP PASSWORD
      ...
      html: `
                ...
                <p>http://localhost:3000/verify-email/${token}</p>
                <hr />
  ...
  User.findOne({ email }, (err, user) => {
    ...
    const emailData = {
      ...
      html: `
                ...
                <p>https://localhost:3000/change-password/${token}</p>
                <hr />
